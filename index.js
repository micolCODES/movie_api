...
mongoose.connect('mongodb+srv://micolcodes:tVAFpod78zlU3XfM@micolsdb.p609irt.mongodb.net/movieAppDB?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true });
...
// all origins allowed:
app.use(cors());
/*//limiting which domains can use my API
